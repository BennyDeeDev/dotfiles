...
- Dim colors (generated from normal colors for terminal dim text)
...
**Note on Dim Colors:** Since Ghostty does not define dim colors, these have been generated by darkening the normal colors (60% brightness for Mocha, 70% for Latte) to provide visual distinction for dimmed text in the terminal.
